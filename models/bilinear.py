...
class Encode_B(nn.Module):
    def __init__(self, in_c, out_c, dilation=1, grid=[1, 1, 1], downsample = True):
        super().__init__()
...
class Bilinear(nn.Module):
    def __init__(self, n_class=21):
        ...
        # conv4
        self.encode4 = Encode_B(256, 512, grid=[2, 2, 2])
        
        # conv5
        self.encode5 = Encode_B(512, 512, grid=[4, 4, 4], downsample = False)

        # conv6
        self.encode6 = Encode_ASP(512, 512, 2, [0.5, 1, 2, 4])

        # decode
        self.decode6_0 = nn.Conv2d(512, 128, 1)
        self.decode6_1 = nn.ConvTranspose2d(128, 128, 3, 2, 1, 1)
        
        self.decode3_0 = nn.Conv2d(256, 128, 1)
        self.decode3_1 = nn.ConvTranspose2d(128, 128, 3, 2, 1, 1)

        self.score = nn.Conv2d(256, n_class, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        decode6 = self.decode6_1(self.decode6_0(h6))
        
        decode3 = self.decode3_1(self.decode3_0(h3))
        
        decode = torch.cat((decode3, decode6), 1)
        
        output = self.score(decode)
